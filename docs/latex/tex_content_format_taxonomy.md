...
- パターン4系(`build_abc_block_tex`・`build_simplify_block_tex`・`build_commondenom_block_tex` ほか)、パターン6(`build_vertical_block_tex`)、パターン7(`build_hundred_square_block_tex`)は未 retrofit。
