...
def _init() -> argparse.Namespace:
    ...
    parser.add_argument('command'
        , type = str
        , choices = ['ope', 'com', '100', '99', 'aBc', 'squ', 'pi', 'frac', 'mixed', 'compare', 'lcm', 'gcd']
        , help = (
            'Type of formula to output (including "frac" for fraction arithmetic, '
            '"compare" for fraction comparison, "mixed" for int/decimal/fraction '
            'arithmetic, and "lcm"/"gcd" for least-common-multiple/'
            'greatest-common-divisor pairs)'
        )
    )
